namespace Lab2.WinLinkLabel
{
    public partial class Form1 : Form
    {
        ...
        {
            //System.Diagnostics.Process.Start("https://google.com/"); // Код из методички для этого обработчика не рабочий. Заменить на мой:
            System.Diagnostics.Process.Start(new System.Diagnostics.ProcessStartInfo { FileName = @"https://google.com/", UseShellExecute = true });
